...
def model(X, Y, layers_dims, optimizer, learning_rate = 0.0007, mini_batch_size = 1, beta = 0.9,
...
def test_random_mini_batches_test_case():
...
# test_random_mini_batches_test_case()
...
test_mini_batch_gradient_descent_momentum()
